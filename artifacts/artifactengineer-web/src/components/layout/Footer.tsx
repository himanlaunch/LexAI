    ...
    <footer style={{ backgroundColor: C.dark, color: "rgba(255,255,255,0.7)", padding: "64px 24px 36px" }}>
      <div style={{ maxWidth: 1024, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 48, marginBottom: 56 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
              ...
              <span style={{ fontFamily: SYS, fontWeight: 600, fontSize: 17, color: C.white, letterSpacing: -0.3 }}>artifactengineer</span>
            </div>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 28, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" as const, gap: 12 }}>
          <div style={{ fontFamily: SYS, fontSize: 12, letterSpacing: "-0.1px", color: "rgba(255,255,255,0.35)" }}>© 2026 artifactengineer Inc. All rights reserved.</div>
