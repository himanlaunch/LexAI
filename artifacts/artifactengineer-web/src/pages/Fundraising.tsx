        ...
        <div style={{ padding: "0 24px 24px", borderTop: `1px solid ${C.grayLt}` }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap" as const, gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div>
                <div style={{ fontFamily: SYS, fontSize: 11, color: C.gray, letterSpacing: "-0.05px" }}>artifactengineer cost</div>
            ...
            >
              <Sparkles size={13} /> Generate with artifactengineer
            </Link>
          </div>
        </div>
      )}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", paddingTop: 10, borderTop: `1px solid ${C.border}` }}>
            <span style={{ fontFamily: SYS, fontSize: 13, fontWeight: 600, color: C.dark }}>artifactengineer total</span>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div ref={ref} style={{
            ...
            <p style={{ fontFamily: SYS, fontSize: 17, letterSpacing: "-0.2px", color: C.gray, maxWidth: 560, lineHeight: 1.55, margin: 0 }}>
              Every document your seed round requires — in the right order. Check off each step as you complete it, and generate the documents instantly with artifactengineer.
            </p>
          </div>
